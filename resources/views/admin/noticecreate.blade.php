                   ...
                   <?php  if(!empty($_GET['id'])){
                     ...
                     <form id="form1" action="{{url('admin/notice/create')}}" enctype="multipart/form-data"
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="testimonials"><input id="testimonials" name="testimonials" type="checkbox" class="chk" value="1"> Testimonials</label>
                            </div>   
                            <div class="form-group">
                                <label for="apprenticeship"><input id="apprenticeship" name="apprenticeship" type="checkbox" class="chk" value="1"> Apprenticeship</label>
                            </div>                   
