                                                ...
                                                <ul class="dropdown-menu menuboxshadow">
                                                    ...
                                                    <li>
                                                        <ul class="todolist">
                                                                                     ...
                                                                                     <li class="cal15"><a data-placement="bottom" data-toggle="tooltip" title="" href="https://easywayglobal.in/admin/chat" data-original-title="Chat" class="todoicon"><i class="fa fa-whatsapp"></i> <span class="todo-indicator">9</span></a></li> 
                    ...
                    <li class="treeview active">
                        ...
                        <ul class="treeview-menu">
                                ...
                                <li class=""><a href="https://easywayglobal.in/student/create"><i class="fa fa-angle-double-right"></i> Student Admission</a></li>
                                    ...
                                    <li class="active"><a href="https://easywayglobal.in/admin/onlinestudent"><i class="fa fa-angle-double-right"></i> Online Admission</a></li>
...
<script>
    function checkpaymentstatus(id){
       $.ajax({
            url: 'https://easywayglobal.in/admin/onlinestudent/checkpaymentstatus',
            type: "POST",
            data: {id:id},
            success: function (data) {
               ...
               if(data!=""){
                    if(confirm(data)){
                      window.location.href="https://easywayglobal.in/admin/onlinestudent/edit/"+id ;
                    }else{
                         return false ;
                    }
                }else{
...
//==============
    ...
    function showdate(type) {
            ...
            var date_from = '17.11.2022';
            var date_to = '17.11.2022';
