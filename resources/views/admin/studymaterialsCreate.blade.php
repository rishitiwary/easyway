            ...
            <section class="content">
                <div class="row">
                    <div class="row">
                        ...
                        @endif
                        <form id="form1" action="{{url('master/studymaterial/create')}}" enctype="multipart/form-data" id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                                ...
                                <div class="box box-primary">
                                    <div class="box-header with-border">
                                        ...
                                        <div class="box-tools pull-right">
                                            <a href="{{url('master/studymaterials')}}" class="btn btn-sm btn-primary"><i class="fa fa-list-alt"></i> Documents List</a>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Document Title</label><small class="req">
                                                *</small>
                                            <input id="name" name="name" placeholder="Enter Video Title" type="text" value="<?= $res[0]->name; ?>" class="form-control" required />
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Upload Documents</label><small class="req">
                                                *</small>
                                            <input id="docs" name="docs" type="file" class="filestyle form-control" />
