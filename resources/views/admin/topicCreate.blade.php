        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="row">
                    ...
                    @endif
                    <form id="form1" action="{{url('master/topic/create')}}" enctype="multipart/form-data"
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    ...
                                    <div class="box-tools pull-right">
                                        <a href="{{url('master/topic')}}" class="btn btn-sm btn-primary"><i
                                                class="fa fa-list-alt"></i> Topics List</a>
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Trade Group Name</label><small class="req">
                                            *</small>
                                        <select id="tradegroup" name="tradegroup" placeholder="Enter Trade Group Name"
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Subject Name</label><small class="req">
                                            *</small>
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Chapter Name</label><small class="req">
                                            *</small>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="name" name="name" placeholder="Enter Trade Group Name" type="text"
