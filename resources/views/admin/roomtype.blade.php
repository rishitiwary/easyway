                ...
                <div class="alert alert-success">
                    ...
                    <div class="col-md-4">
                        <div class="box box-primary">
                            ...
                            <form id="form1" action="{{url('admin/roomtype')}}" id="employeeform"
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input autofocus="" id="amount" name="room_type" placeholder="" type="text"
                                            class="form-control" value="<?=$res[0]->room_type?>"  required/>
                                        <span class="text-danger"></span>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Description</label>
                                        <textarea class="form-control" id="description" name="description"
                                            placeholder="" rows="3" placeholder="" required><?=$res[0]->description?></textarea>
                                        <span class="text-danger"></span>
                                    </div>
                                </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="mailbox-name">
                                                        <a href="#" data-toggle="popover" class="detail_popover"><?=$row->room_type?></a>
                                                    ...
                                                    <td class="mailbox-date pull-right no-print">
                                                        <a data-placement="left"
                                                            href="{{url('admin/roomtype?uid=')}}<?=$row->id?>"
                                                            class="btn btn-default btn-xs" data-toggle="tooltip"
                                                            title="Edit">
                                                            <i class="fa fa-pencil"></i>
                                                        </a>
                                                        <a data-placement="left"
                                                            href="{{url('admin/roomtype?delid=')}}<?=$row->id?>"
                                                            class="btn btn-default btn-xs" data-toggle="tooltip"
