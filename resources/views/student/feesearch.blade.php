                    ...
                    <li class="treeview ">
                        ...
                        <ul class="treeview-menu">
                                                            <li class=""><a href="https://easywayglobal.in/studentfee"><i class="fa fa-angle-double-right"></i> Collect Fees</a></li>
                                                                <li class=""><a href="https://easywayglobal.in/studentfee/searchpayment"><i class="fa fa-angle-double-right"></i> Search Fees Payment</a></li>
                                                                <li class="active"><a href="https://easywayglobal.in/studentfee/feesearch"><i class="fa fa-angle-double-right"></i> Search Due Fees </a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form action="https://easywayglobal.in/studentfee/feesearch"  method="post" accept-charset="utf-8">
                        <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select autofocus="" id="feegroup_id" name="feegroup_id" class="form-control" >
                                            <option value="">Select</option>
                                                                                            <optgroup label="HOSTEL FEE">
                                                                                                                <option   value="20-44">HOS-07</option>
                                                                                                                </optgroup>
                                                                                                <optgroup label="EASYWAY TRADE">
                                                                                                                <option   value="17-41">TT-03</option>
                                                                                                                </optgroup>
                                                                                                <optgroup label="EASYWAY MATH">
                                                                                                                <option   value="18-42">MT-04</option>
                                                                                                                </optgroup>
                                                                                                <optgroup label="EASYWAY REASONING">
                                                                                                                <option   value="19-43">RES-05</option>
                                                                                                                </optgroup>
                                                                                                <optgroup label="EASYWAY COMPUTER">
                                                                                                                <option   value="21-45">COM-06</option>
                                                                                                                </optgroup>
                                                                                                <optgroup label="EASYWAY REGISTRATION FEE">
                                                                                                                <option   value="22-46">EWG-01</option>
                                                                                                                </optgroup>
                                                                                                <optgroup label="HOSTEL REGISTRATION FEE">
                                                                                                                <option   value="23-47">HRE-02</option>
                                                                                                                </optgroup>
                                                                                        </select>
...
<div style="border:1px solid #990000;padding-left:20px;margin:0 0 10px 0;">
    ...
    <p>Filename: studentfee/studentSearchFee.php</p>
    <p>Line Number: 83</p>
        ...
        <p>Backtrace:</p>
                ...
                <p style="margin-left:10px">
                    File: /home/easywayglobal/public_html/application/views/studentfee/studentSearchFee.php<br />
                    Line: 83<br />
                ...
                <p style="margin-left:10px">
                    File: /home/easywayglobal/public_html/application/controllers/Studentfee.php<br />
                    Line: 229<br />
                    Function: view                </p>
...
</div>                                                <option value="14" >TURNER</option>
