                    ...
                    <li class="treeview ">
                        ...
                        <ul class="treeview-menu">
                                                            <li class=""><a href="https://easywayglobal.in/studentfee"><i class="fa fa-angle-double-right"></i> Collect Fees</a></li>
                                                                ...
                                                                <li class="active"><a href="https://easywayglobal.in/admin/feesforward"><i class="fa fa-angle-double-right"></i> Fees Carry Forward</a></li>
...
<div class="content-wrapper" style="min-height: 946px;">
    ...
    <section class="content">
        <div class="row">  
            <form id='feesforward' action="https://easywayglobal.in/admin/feesforward/index"  method="post" accept-charset="utf-8">
                <div class="col-md-12">
...
<div style="border:1px solid #990000;padding-left:20px;margin:0 0 10px 0;">
    ...
    <p>Filename: feesforward/index.php</p>
    <p>Line Number: 42</p>
        ...
        <p>Backtrace:</p>
                ...
                <p style="margin-left:10px">
                    File: /home/easywayglobal/public_html/application/views/admin/feesforward/index.php<br />
                    Line: 42<br />
                ...
                <p style="margin-left:10px">
                    File: /home/easywayglobal/public_html/application/controllers/admin/Feesforward.php<br />
                    Line: 99<br />
                    Function: view                </p>
                ...
                <p style="margin-left:10px">
                    ...
                    Function: require_once                </p>
                            ...
                            <div class="">
                                <button type="submit" name="action" value ="search" class="btn btn-primary pull-right">Search</button>
                            </div>
                        </div>  
