                    ...
                    <li class="treeview ">
                        ...
                        <ul class="treeview-menu">
                                                            <li class=""><a href="https://easywayglobal.in/studentfee"><i class="fa fa-angle-double-right"></i> Collect Fees</a></li>
                                                                ...
                                                                <li class="active"><a href="https://easywayglobal.in/admin/feereminder/setting"><i class="fa fa-angle-double-right"></i> Fees Reminder</a></li>
...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <!-- left column -->
                <form id="form1" action="https://easywayglobal.in/admin/feereminder/setting"  id="feereminder" name="feereminder" method="post" accept-charset="utf-8">
