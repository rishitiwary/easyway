    ...
    <li class="dropdown">
        ...
        <ul class="sidebar-menu verttop">
                    ...
                    <li class="treeview ">
                        ...
                        <ul class="treeview-menu">
                                                            <li class="active"><a href="https://easywayglobal.in/studentfee"><i class="fa fa-angle-double-right"></i> Collect Fees</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form  action="https://easywayglobal.in/studentfee/search" method="post" class="class_search_form">
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <button type="submit" class="btn btn-primary btn-sm pull-right" name="class_search" data-loading-text="Please wait.." value=""><i class="fa fa-search"></i> Search</button>
                                            </div>
                                        </div>
            ...
            <input type="text" name="search_text" id="search_text" class="form-control" value="" placeholder="Search By Student Name, Roll Number, Enroll Number, National Id, Local Id Etc.">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                               <button type="submit" class="btn btn-primary btn-sm pull-right" name="keyword_search" data-loading-text="Please wait.." value=""><i class="fa fa-search"></i> Search</button>
                                            </div>
                                        </div>
                        ...
                        <div class="">
                            ...
                            <div class="box-body">
                                ...
                                <table class="table table-striped table-bordered table-hover student-list" data-export-title="Student List">
                                    <thead>
