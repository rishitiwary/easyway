                ...
                <div class="alert alert-success">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="nav-tabs-custom border0 navnoshadow">
                            ...
                            <div class="">
                                <div class="box-header with-border">
                                    <h3 class="box-title"><i class="fa fa-users"></i> Assign Fees Discount </h3>
                                                    ...
                                                    <table class="table">
                                                        <tbody>
                                                            ...
                                                            <tr class="mailbox-name">
                                                                <input type="hidden" name="feediscount_id" value="{{$fees->id}}">
                                                                <td>
                                                                    {{$fees->name}} </td>
                                                                <td>
                                                                    ₹{{$fees->amount}} </td>
...
<form method="post" action="">
    ...
    <input type="hidden" name="feediscount_id" value="{{$fees->id}}">
                                                <div class=" table-responsive">
                                                    ...
                                                    <table class="table table-striped">
                                                        <tbody>
                                                            ...
                                                            @foreach($rows as $run)
                                                            <?php  $check=DB::select('select id from student_fees_discounts where student_id='.$run->id.' and fees_discount_id='.$fees->id);
                                                                    
                                                                    
                                                                        ?>
                                                            <tr>
                                                                <td>
                                                                    <input class="checkbox" type="checkbox" name="student_session_id[]" value="{{$run->id}}"
                                                                    @if($check[0]!='') checked @endif
                                                ...
                                                <button type="submit" class="allot-fees pull-right btn btn-primary btn-sm " name="save" value="save" id="load" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Please Wait..">Save </button>
</form>
                                                <br>
                                                <br>
                                            </div>
