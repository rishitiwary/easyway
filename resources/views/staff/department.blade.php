                ...
                <div class="alert alert-success">
                    ...
                    <div class="col-md-4">
                        <div class="box box-primary">
                            ...
                            <form id="form1" action="{{url('admin/department')}}" id="employeeform"
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input autofocus="" id="name" name="department" placeholder="" type="text"
                                            class="form-control" value="<?=$res[0]->department?>"  required/>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="mailbox-name">
                                                        <a href="#" data-toggle="popover" class="detail_popover"><?=$row->department?></a>
                                                      
                                                    </td>
                                                    <td class="mailbox-date pull-right no-print">
                                                        <a data-placement="left"
                                                            href="{{url('admin/department?uid=')}}<?=$row->id?>"
                                                            class="btn btn-default btn-xs" data-toggle="tooltip"
                                                            title="Edit">
                                                            <i class="fa fa-pencil"></i>
                                                        </a>
                                                        <a data-placement="left"
                                                            href="{{url('admin/department?delid=')}}<?=$row->id?>"
                                                            class="btn btn-default btn-xs" data-toggle="tooltip"
